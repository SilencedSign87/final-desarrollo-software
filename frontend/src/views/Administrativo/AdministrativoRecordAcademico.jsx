...
export default function AdministrativoRecordAcademico() {
    const query = useQuery("administrativo_record_academico")
    ...
    const handleGenerateReport = async () => {
        ...
        setLoading(true)
        try {
            const response = await EvaluacionService.getReporteRecordAcademico({
                periodo_academico_id: periodoAcademico,
            })
            const url = window.URL.createObjectURL(new Blob([response.data]))
            const link = document.createElement("a")
            link.href = url
            link.setAttribute("download", "reporte_record_academico.pdf")
        ...
        <>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">Reporte de Record Académico</h1>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            disabled={!periodoAcademico || loading || data === undefined}
